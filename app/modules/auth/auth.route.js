...
router.post('/change-password', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.ARTIST), (0, validateRequest_1.default)(auth_validation_1.AuthValidation.createChangePasswordZodSchema), auth_controller_1.AuthController.changePassword);
router.post('/social-login', auth_controller_1.AuthController.socialLogin);
router.post('/refresh-token', auth_controller_1.AuthController.issueNewAccess);
router.get('/test-access', auth_controller_1.AuthController.testAccess);
