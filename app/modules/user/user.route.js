...
router.get('/profile', (0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.USER, user_1.USER_ROLES.ARTIST), user_controller_1.UserController.getUserProfile);
router
    .route('/')
    ...
    .delete((0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.ARTIST), user_controller_1.UserController.deleteUser)
