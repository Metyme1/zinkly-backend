...
router.post('/create', (0, auth_1.default)(user_1.USER_ROLES.ARTIST), (0, validateRequest_1.default)(lesson_validation_1.LessonValidation.createLessonZodSchema), lesson_controller_1.LessonController.createLesson);
