...
const sendNotifications = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const notification = yield notification_model_1.Notification.findById(result._id).populate({ path: "sender", select: "name profile" }).select("text sender read createdAt");
    //@ts-ignore
    const socketIo = global.io;
    if (socketIo) {
        socketIo.emit(`get-notification::${data === null || data === void 0 ? void 0 : data.receiver}`, notification);
    }
    return result;
});
