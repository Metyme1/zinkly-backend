...
router
    ...
    .post((0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), rule_controller_1.RuleController.createTermsAndCondition)
...
router
    .route('/disclaimer')
    .post((0, auth_1.default)(user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), rule_controller_1.RuleController.createDisclaimer)
