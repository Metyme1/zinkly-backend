...
const loginUserFromDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const refreshToken = jwtHelper_1.jwtHelper.createToken({ id: isExistUser._id, role: isExistUser.role, email: isExistUser.email }, config_1.default.jwt.refresh_secret, config_1.default.jwt.refresh_expires_in);
    return { token: createToken, role: isExistUser === null || isExistUser === void 0 ? void 0 : isExistUser.role, refreshToken };
});
//forget password
...
const issueNewAccessToken = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingUser = yield user_model_1.User.findById(verifyUser === null || verifyUser === void 0 ? void 0 : verifyUser.id);
...
const socialLoginFromDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isExistUser) {
        ...
        //create token
        const refreshToken = jwtHelper_1.jwtHelper.createToken({ id: isExistUser._id, role: isExistUser.role }, config_1.default.jwt.jwt_secret, config_1.default.jwt.jwt_expire_in);
        ...
        //create token
        const refreshToken = jwtHelper_1.jwtHelper.createToken({ id: user._id, role: user.role }, config_1.default.jwt.jwt_secret, config_1.default.jwt.jwt_expire_in);
        return { token: accessToken, role, refreshToken };
    }
});
exports.AuthService = {
