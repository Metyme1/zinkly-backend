...
const createBooking = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existing = yield booking_model_1.Booking.findOne({
    ...
    if (existing) {
        ...
        const artist = yield user_model_1.User.findById(payload.artist);
        const zoomMeeting = yield zoon_service_1.ZoomService.createMeeting((artist === null || artist === void 0 ? void 0 : artist.name) || 'Musician', 'Music Lesson', payload.booking_date, payload.booking_time);
...
const toggleMultiUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { bookingId, allowMultiple } = req.body;
    console.log(`🔄 Toggling multi-user for booking ${bookingId} → ${allowMultiple}`);
    const booking = yield booking_model_1.Booking.findByIdAndUpdate(bookingId, { allowMultiple }, { new: true });
    if (!booking) {
...
const toggleMultiUserForSlot = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { zoomJoinUrl, allowMultiple } = req.body;
    const artistId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id; // 👈 this is throwing the error if req.user is undefined
    if (!artistId) {
        return (0, sendResponse_1.default)(res, {
    ...
    const result = yield booking_model_1.Booking.updateMany({
        artist: artistId,
...
const myBookingFromDB = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield booking_service_1.BookingService.myBookingFromDB(userId, queryStatus);
